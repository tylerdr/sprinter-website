...
export const metadata: Metadata = {
  ...
  description: "60% touchless invoices in 30-45 days. Works with QBO, Sage, and upload-only ERPs. Clear acceptance criteria, full audit trail, exception SLA <48h.",
  keywords: "AP automation, expense automation, QuickBooks automation, Sage automation, invoice processing, touchless invoices, ERP automation",
};
