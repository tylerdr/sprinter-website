...
export const metadata: Metadata = {
  title:
    "Pacific Trust Bank – AI Mortgage Underwriting Case Study – Sprinter AI",
  description:
    "How Sprinter AI built an AI-powered mortgage underwriting system that reduced processing time by 70% and saved $3.2M annually for Pacific Trust Bank.",
};
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Regional bank serving Washington State
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Strong community presence since 1987
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-blue-400 mb-2">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6">
                <span className="text-info">Our Solution</span>
              </h2>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 rounded-lg bg-info-10 border border-info-30">
                    <h4 className="font-semibold mb-3 text-info">
                      Frontend Components
                    </h4>
                    <ul className="text-sm text-gray-400 space-y-2">
                      <li>
                        <strong>Loan Officer Dashboard:</strong> React-based
                        interface with real-time status tracking
                      </li>
                      <li>
                        <strong>Document Upload Portal:</strong> Drag-and-drop
                        with OCR preview
                      </li>
                      <li>
                        <strong>Risk Assessment Views:</strong> Interactive
                        scoring visualizations
                      </li>
                      <li>
                        <strong>Compliance Reporting:</strong> Automated
                  ...
                  <div className="p-6 rounded-lg bg-info-10 border border-info-30">
                    ...
                    <ul className="text-sm text-gray-400 space-y-2">
                      <li>
                        <strong>ML Pipeline:</strong> Python-based ensemble
                        models (XGBoost, Random Forest)
                      </li>
                      <li>
                        <strong>Data Integration:</strong> APIs to Experian,
                        LexisNexis, CoreLogic
                      </li>
                      <li>
                        <strong>Document Processing:</strong> Tesseract OCR with
                        custom financial parsers
                      </li>
                      <li>
                        <strong>Core Banking Integration:</strong> Seamless
                        connection to FIS systems
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400">
                        System assessment, data mapping, ML model design
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400">
                        OCR pipeline, ML training, API integrations
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400">
                        Model validation, UAT with loan officers
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-400">
                        Staged rollout, training, go-live support
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6">
                <span className="text-success">Detailed Results</span>
              </h2>
                ...
                <div className="p-6 rounded-lg border border-info-30 bg-info-10">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-info">$3.2M</span>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              <div className="p-8 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-white/10">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">
                      SVP of Lending Operations, Pacific Trust Bank
                    </div>
                  </div>
                </div>
              </div>
