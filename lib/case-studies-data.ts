...
export const caseStudies: CaseStudy[] = [
  {
    ...
    testimonial: "The AI doesn't just help us manage Non-QM complexity—it turned it into our competitive advantage. We're closing loans 300% faster with the confidence of having a senior underwriter available 24/7.",
    features: [
      "Visual AI catalog parser for PDFs and images",
      "Multi-agent parallel lender research",
      "Field normalization across divergent nomenclatures",
      "Evidence-backed answers with guideline citations",
      "'Just Missed' analytics for lenders",
      "Human-in-the-loop confidence thresholds",
      "Real-time CDC/regulatory protocol updates",
  ...
  },
  {
    ...
    testimonial: "This isn't just automation—it's transformation. We quote more options, close faster, and our designers focus on design instead of spreadsheets. The ROI was evident within weeks.",
    features: [
  ...
  },
  {
    ...
    description: "How AI-driven patient monitoring enabled 5× coverage while reducing readmissions by 40%",
    challenge: "Healthcare system managing 12,000+ chronic patients with 60 nurses. Each nurse juggling 200+ patients, spending 70% of time on routine check-ins while missing critical health deterioration signals. Manual monitoring led to 30% readmission rates, $8M annual penalties, and nurse burnout with 45% turnover.",
    solution: "Deployed autonomous AI care coach that conducts intelligent patient check-ins via voice/text/app, analyzes responses using clinical NLP models, triages by acuity with predictive risk scoring, and escalates critical cases to nurses in real-time. System personalizes education based on health literacy and integrates with Epic EHR for seamless documentation.",
    results: [
    ...
    testimonial: "The AI coach transformed our care model. Nurses now manage 5× more patients with better outcomes because they focus on those who need them most. We've avoided millions in penalties while improving both patient and staff satisfaction.",
    features: [
  ...
  },
  {
    ...
    testimonial: "Amble didn't just digitize our workshops—it revolutionized our entire innovation practice. We can now run 10 workshops simultaneously across continents, with AI surfacing insights we would have missed. It's become our competitive differentiator.",
    features: [
  ...
  },
  {
    ...
    description: "How AI-generated content at scale drove 400% organic growth and $3M incremental revenue",
    challenge: "E-commerce aggregator needed 10,000+ unique product pages for SEO dominance but had 2 content writers producing 5 pages/day. Manual approach would take 5.5 years and $2M in writer costs. Competitors launching 500+ pages daily while client losing organic rankings. Google's helpful content update demanded high-quality, unique content at scale.",
    solution: "Built end-to-end AI content pipeline that scrapes product data from 50+ sources, analyzes reviews using sentiment models, generates unique long-form content with E-E-A-T signals, creates comparison tables and buying guides programmatically, and optimizes for featured snippets and SGE. System includes quality scoring, plagiarism detection, and human review workflow.",
    results: [
    ...
    testimonial: "This AI engine accomplished in 3 months what would've taken our team 3 years and $2M. We went from invisible to dominating long-tail searches. The ROI is extraordinary—we're now the category leader in organic traffic.",
    features: [
