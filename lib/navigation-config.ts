  ...
  main: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Compete Against Complexity",
          href: "/approach#compete-complexity",
          icon: Target,
        ...
        {
          label: "Unlimited Capacity Thinking",
          href: "/approach#unlimited-capacity",
          icon: Lightbulb,
          description: "Rethink processes from first principles when labor isn't a constraint",
        },
      ],
    },
    {
